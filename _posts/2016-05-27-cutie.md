...
Just to test inline R expressions[^2] in **knitr**, we know the first element in `x` (created in the code chunk above) is 2. You can certainly draw some graphs as well:
...
![A scatterplot of the cars data](/labnotebookfigure/source/2016-05-27-cutie/cars-1.png)
